...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/swiperinfo_update.action" method="post" id="addForm">
                 <input name="id" type="hidden" value="${swiperinfo.id}"/>
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-9 form-inline"  >
                                                                                    <input id="pic" readonly="readonly" name="pic" value="${swiperinfo.pic}"  size="35" class="form-control"   type="text"   tip="请上传文件" />
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                                    ...
                                                    <c:forEach items="${novelinfoList}" var="info">
                                                        <option <c:if test="${swiperinfo.novelid==info.id}">selected</c:if>  value="${info.id}">${info.name}</option>
                                                    </c:forEach>
                                                </select>
                                    </div>
                                </div>
