                ...
                <div class="container-fluid">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                            ...
                                            <input id="uname" name="uname" size="35" class="form-control" readonly="readonly"  type="text" value="${tadmin.uname}"  tip="请输入用户名" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                                                            <label class="col-sm-3 control-label"><font color="red">*</font>电话 </label>
                                                                        <div class="col-sm-9 form-inline"  >
                                            <input id="tel" name="tel" size="35" class="form-control"   type="text" value="${tadmin.tel}"  tip="请输入电话" />
                                    </div>
                                </div>
                            </div>
                        </div>
