...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/novelcategory_update.action" method="post" id="addForm">
                 <input name="id" type="hidden" value="${novelcategory.id}"/>
                <div class="container-fluid">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                            ...
                                            <input id="name" name="name" size="35" class="form-control"   type="text" value="${novelcategory.name}"  tip="请输入分类名称" />
                                    </div>
                                </div>
                            </div>
                        </div>
