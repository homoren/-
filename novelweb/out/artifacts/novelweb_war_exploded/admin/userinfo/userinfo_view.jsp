                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 form-inline">
                                <input id="tel" name="tel" size="35" value="${userinfo.tel}" readonly="readonly"
                ...
                <div class="row rowmargin">
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 form-inline">
                                <input id="nickname" name="nickname" size="35" value="${userinfo.nickname}"
                ...
                <div class="row rowmargin">
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 form-inline">
                                <input id="birthday" name="birthday" size="35" value="${userinfo.birthday}"
                                       readonly="readonly" class="form-control" type="text"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row rowmargin">
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 form-inline">
                                <input id="sex" name="sex" size="35" value="${userinfo.sex}" readonly="readonly"
                                       class="form-control" type="text"/>
                            </div>
                        </div>
                    </div>
