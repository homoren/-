...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/noticeinfo_update.action" method="post" id="addForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 form-inline">
                                    <input id="title" name="title" size="35" class="form-control" type="text"
                                           value="${noticeinfo.title}" tip="请输入公告标题"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 form-inline">
                                    ...
                                    <input id="tcontents" name="tcontents" type="hidden"/>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        ue.ready(function () {
            //设置编辑器的内容
            ue.setContent('${noticeinfo.tcontents}');
        });
        ...
        $("#addForm").validate({
            submitHandler: function (form) {//验证通过后的执行方法
                ...
                document.getElementById("tcontents").value = htmlv;
                form.submit();
            },
            rules: {
                title: {
