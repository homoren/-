...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/novelcomment_add.action" method="post" id="addForm">
               ...
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <textarea rows="5" cols="80" id="contents" name="contents" class="form-control" tip="请输入评论内容"></textarea>
								</div>
							</div>
						</div>
					</div>
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                            <input id="commenttime" name="commenttime" size="35" class="form-control" readonly="readonly" onClick="WdatePicker()"  type="text" value=""  tip="请输入评论时间" />
								</div>
							</div>
						</div>
					</div>
